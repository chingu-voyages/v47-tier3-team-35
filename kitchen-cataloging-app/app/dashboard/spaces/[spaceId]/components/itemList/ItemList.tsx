...
import { InventoryListItemGridWrapper } from "@/components/inventoryList/wrappers/InventoryListGridWrapper";
...
export default function ItemList({
  ...
  return (
    <InventoryList defaultItems={defaultItems}>
      {(props) => (
        <InventoryListItemGridWrapper key={props.item.id}>
          <Link
